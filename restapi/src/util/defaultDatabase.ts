...
export default async function create() {
    ...
    await ProductModel.create({photo:' https://as01.epimg.net/meristation/imagenes/2019/08/20/cover/888153891566327582.jpg', name: 'Fifa 20', price:'20', stock:'2',description:'publicados anualmente por Electronic Arts bajo el sello de EA Sports creado en Japón Cuando la saga comenzó a finales de 1993', categories:juego1})
    await ProductModel.create({photo:' https://s2.gaming-cdn.com/images/products/2665/orig/fifa-19-pc-juego-origin-cover.jpg', name: 'Fifa 19', price:'30', stock:'67', description:'publicados anualmente por Electronic Arts bajo el sello de EA Sports creado en Japón Cuando la saga comenzó a finales de 1993',  categories:juego2 })
    await ProductModel.create({photo:' https://image.api.playstation.com/vulcan/ap/rnd/202107/1612/0b0owDFqekJszSOQfD4vvTjy.png', name: 'Elden ring', price:'80', stock:'4', description:' rol de acción desarrollado por FromSoftware y publicado por Bandai Namco Entertainment',  categories:juego3  })
