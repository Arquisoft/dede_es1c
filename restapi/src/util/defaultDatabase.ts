...
export default async function create() {
    ...
    await ProductModel.create({ photo: 'https://drive.google.com/uc?export=view&id=1TQef18uKm-07aO5_-aN0HexJEIFpJ6RU', name: 'The Elder Scrolls V: Skyrim', price: '10', stock: '99', description: 'Es un ARPG del tipo mundo abierto desarrollado por Bethesda Game Studios.', categories: juego24 });
