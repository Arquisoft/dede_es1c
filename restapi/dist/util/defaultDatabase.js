...
function create() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield model_2.UserModel.create({ personal_identification: '1D', name: 'Alvaro', surname: 'Lopez', password: '123', email: 'a@gmail.com', role: model_2.ROLES.NORMAL, phone: '111', country: 'España', province: 'Asturias', city: 'Mieres', zip_code: 33600, street: 'C/Hola', number: 2, floor: 1, floor_number: 'A' });
        yield model_2.UserModel.create({ personal_identification: '1D', name: 'Hector', surname: 'Lopez', password: '123', email: 'b@gmail.com', role: model_2.ROLES.ADMIN, phone: '111', country: 'España', province: 'Asturias', city: 'Mieres', zip_code: 33600, street: 'C/Hola', number: 2, floor: 1, floor_number: 'B' });
    });
}
